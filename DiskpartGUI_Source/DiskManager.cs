...
namespace DiskpartGUI
{
    ...
    public class DiskManager
    {
        ...
        public void RunDiskpart(string script, string label)
        {
            ...
            OnOutputReceived?.Invoke($"--- {label} COMPLETED ---");
        }
        ...
        public string BuildFormatScript(int diskIndex, bool isGpt, int bootSize, int windowsSizeGb, bool createRecovery, int recoverySizeMb, long totalDiskSizeGB)
        {
            ...
            if (isGpt)
            {
                ...
                sw.WriteLine("set id=\"c12a7328-f81f-11d2-ba4b-00a0c93ec93b\"");
